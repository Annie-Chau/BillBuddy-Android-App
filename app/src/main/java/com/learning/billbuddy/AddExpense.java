...
public class AddExpense extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datePicker = findViewById(R.id.add_expense_date_picker);
        ...
        splitTypeSpinner = findViewById(R.id.add_expense_split_type);
        currencySpinner = findViewById(R.id.add_expense_currency);
        saveButton = findViewById(R.id.add_expense_save_button);
        ...
        saveButton.setOnClickListener(v -> {
            ...
            if (amount <= 0) {
                Toast.makeText(AddExpense.this, "Amount must be greater than 0", Toast.LENGTH_SHORT).show();
                return;
            }
            if (date.isEmpty()) {
                Toast.makeText(AddExpense.this, "Please select a date", Toast.LENGTH_SHORT).show();
                return;
            }
//            if (paidBy == null || paidBy.isEmpty()) {
//                Toast.makeText(AddExpense.this, "Please select who paid", Toast.LENGTH_SHORT).show();
//                return;
//            }
            if (splitType == null || splitType.isEmpty()) {
                Toast.makeText(AddExpense.this, "Please select split type", Toast.LENGTH_SHORT).show();
                return;
            }
